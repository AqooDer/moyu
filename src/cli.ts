...
uiCommand
  ...
  .action(async (opts) => {
    ...
    console.log(
      "api: /api/workbench, /api/settings, /api/works, /api/messages, /api/agents, /api/runs/:id, /api/artifacts/:id, /api/artifact-preview, /api/artifact-content, /api/artifact/open, /api/run/open-trace, /api/meta/create-agent, /api/meta/install-agent, /api/meta/install-agent/version, /api/meta/install-agent/diff, /api/agent/run",
    );
  });
