...
uiCommand
  ...
  .action(async (opts) => {
    ...
    console.log(
      "api: /api/workbench, /api/agents, /api/runs/:id, /api/artifacts/:id, /api/artifact-content, /api/artifact/open, /api/run/open-trace, /api/meta/create-agent, /api/meta/install-agent, /api/agent/run",
    );
  });
